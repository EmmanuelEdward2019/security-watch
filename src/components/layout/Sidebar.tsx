  ...
  complainant: [
    {
      ...
      items: [
        ...
        // One place to check in on every safeguard at once. Someone with three
        // arrangements should not have to visit three cases to keep them
        // alive — forgetting one is what turns into a disclosure.
        { to: '/app/custodian', label: 'Safeguards', icon: ShieldCheck },
      ],
    },
  ],
  ...
  investigator: [
    {
      ...
      items: [
        ...
        { to: '/app/custodian', label: 'Custodianships', icon: ShieldAlert },
  ...
  admin: [
    {
      ...
      items: [
        ...
        { to: '/app/admin/corroboration', label: 'Corroborated Incidents', icon: Users },
      ],
    },
    {
      title: 'Content',
      items: [
        ...
        { to: '/app/admin/referrals', label: 'Referral Directory', icon: LifeBuoy },
      ],
    },
    {
      title: 'Finance',
